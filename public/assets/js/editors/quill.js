    ...
    return /******/ (function (modules) {
        ...
        /******/ [
            ...
            /***/ function (module, exports, __webpack_require__) {
                ...
                var Attributor = (function () {
                    ...
                    Attributor.prototype.canAdd = function (node, value) {
                        ...
                        if (
                            match != null &&
                            (this.whitelist == null || this.whitelist.indexOf(value) > -1)
                        ) {
                            return true;
                        }
                        return false;
            ...
            /***/ function (module, exports, __webpack_require__) {
                ...
                var Quill = (function () {
                    ...
                    function Quill(container) {
                        ...
                        this.emitter.on(
                            _emitter2.default.events.TEXT_CHANGE,
                            function (delta) {
                    ...
                    _createClass(Quill, [
                        ...
                        },
                        {
                            ...
                            value: function formatLine(index, length, name, value, source) {
                                ...
                                var range = this.getSelection();
                                var change = this.editor.formatLine(
                                    index,
                                    length,
                                    formats,
                                    source
                        ...
                        },
                        {
                            ...
                            value: function formatText(index, length, name, value, source) {
                                ...
                                var range = this.getSelection();
                                var change = this.editor.formatText(
                                    index,
                                    length,
                                    formats,
                                    source
                        ...
                        },
                        {
                            ...
                            value: function insertEmbed(index, embed, value) {
                                ...
                                var range = this.getSelection();
                                var change = this.editor.insertEmbed(
                                    index,
                                    embed,
                                    value,
                                    source
                        ...
                        },
                        {
                            ...
                            value: function insertText(index, text, name, value, source) {
                                ...
                                var change = this.editor.insertText(
                                    index,
                                    text,
                                    formats,
                                    source
                            ...
                            value: function pasteHTML(index, html) {
                                ...
                                if (typeof index === "string") {
                                    ...
                                    return this.updateContents(
                                        new _delta2.default().retain(index).concat(paste),
                                        source
                                    );
                                }
                            },
                ...
                function expandConfig(container, userConfig) {
                    ...
                    if (
                        ...
                        userConfig.modules.toolbar != null &&
                ...
                function shiftRange(range, index, length, source) {
                    ...
                    if (index instanceof _delta2.default) {
                        ...
                        var _map3 = [range.index, range.index + range.length].map(function (
                            ...
                            if (
                                pos < index ||
                                (pos === index && source !== _emitter2.default.sources.USER)
                            )
                                return pos;
                            if (length >= 0) {
                                return pos + length;
                    ...
                    _createClass(Editor, [
                                    ...
                                    if (op.insert != null) {
                                        if (typeof op.insert === "string") {
                                            ...
                                            if (line instanceof _block2.default) {
                                                ...
                                                var _line$descendant2 = _slicedToArray(
                                                    _line$descendant,
                                                    1
                                                );
                        ...
                        },
                        {
                            ...
                            value: function deleteText(index, length) {
                                ...
                                return this.update(
                                    new _delta2.default().retain(index).delete(length),
                                    source
                                );
                            },
                        },
                        ...
                        },
                        {
                            ...
                            value: function isBlank() {
                                ...
                                return (
                                    child.length() <= 1 &&
                                    Object.keys(child.formats()).length == 0
                                );
                            },
                        },
                        {
                            ...
                            value: function removeFormat(index, length, source) {
                                ...
                                var diff = contents.diff(
                                    new _delta2.default().insert(text).concat(suffix)
                                );
                            ...
                            value: function update(change) {
                                ...
                                if (
                                    ...
                                    (function () {
                                        ...
                                        var newText = new _delta2.default().insert(
                                            textBlot.value()
                                        );
                                        var diffDelta = new _delta2.default()
                                            .retain(index)
                                            .concat(oldText.diff(newText));
                ...
                var BlockEmbed = (function (_Embed) {
                    ...
                    _createClass(BlockEmbed, [
                        ...
                        },
                        {
                            key: "delta",
                            value: function delta() {
                                return new _delta2.default().insert(
                                    this.value(),
                                    (0, _extend2.default)(
                                        this.formats(),
                            ...
                            value: function restore() {
                                ...
                                if (
                                    ...
                                    this.selection.emitter.once(
                                        ...
                                        function () {
                                            var _map = [range.start.offset, range.end.offset].map(
                                                function (offset) {
                                                    return Math.max(
                                                        0,
                                                        Math.min(textNode.data.length, offset - 1)
                                                    );
                                                }
                                            );
                                            ...
                                            _this2.selection.setNativeRange(
                                                textNode,
                                                start,
                                                textNode,
                                                end
                        ...
                        },
                        {
                            ...
                            value: function update(mutations) {
                                ...
                                mutations.forEach(function (mutation) {
                                    if (
                                        mutation.type === "characterData" &&
                                        mutation.target === _this3.textNode
                                    ) {
                                        _this3.restore();
                                    }
                                });
                    ...
                    _createClass(Selection, [
                        ...
                        },
                        {
                            ...
                            value: function getBounds(index) {
                                ...
                                var containerBounds =
                                    this.root.parentNode.getBoundingClientRect();
                                return {
                            ...
                            value: function scrollIntoView() {
                                ...
                                if (this.root.offsetHeight < bounds.bottom) {
                                    ...
                                    this.root.scrollTop =
                                        ...
                                        line.domNode.offsetHeight -
                                        this.root.offsetHeight;
                                } else if (bounds.top < 0) {
                                    var _scroll$line3 = this.scroll.line(
                                        Math.min(range.index, this.scroll.length() - 1)
                                    );
                            ...
                            value: function setNativeRange(startNode, startOffset) {
                                ...
                                if (startNode != null) {
                                    ...
                                    if (
                                        nativeRange == null ||
                                        force ||
                                        startNode !== nativeRange.start.node ||
                                        startOffset !== nativeRange.start.offset ||
                                        endNode !== nativeRange.end.node ||
                                        endOffset !== nativeRange.end.offset
                                    ) {
                                        var range = document.createRange();
            ...
            /***/ function (module, exports, __webpack_require__) {
                            ...
                            value: function convert(html) {
                                ...
                                this.matchers.forEach(function (pair) {
                                    ...
                                    switch (selector) {
                                        ...
                                        default:
                                            [].forEach.call(
                                                _this2.container.querySelectorAll(selector),
                                                function (node) {
                                                    // TODO use weakmap
                                ...
                                if (
                                    ...
                                    delta = delta.compose(
                                        new _delta2.default().retain(delta.length() - 1).delete(1)
                                    );
                                }
                ...
                function matchAlias(format, node, delta) {
                    return delta.compose(
                        new _delta2.default().retain(
                            delta.length(),
                            _defineProperty({}, format, true)
                        )
                    );
                }
                ...
                function matchAttributor(node, delta) {
                    ...
                    if (Object.keys(formats).length > 0) {
                        delta = delta.compose(
                            new _delta2.default().retain(delta.length(), formats)
                        );
                    }
                    return delta;
                }
            ...
            /***/ function (module, exports, __webpack_require__) {
                ...
                var FontStyle = new _parchment2.default.Attributor.Style(
                    "font",
                    "font-family",
                    config
                );
                    ...
                    _createClass(Keyboard, null, [
                        {
                            ...
                            value: function match(evt, binding) {
                                ...
                                if (
                                    !!binding.shortKey !== evt[SHORTKEY] &&
                                    binding.shortKey !== null
                                )
                                    return false;
                                if (
                        ...
                        },
                        {
                            ...
                            value: function listen() {
                                ...
                                this.quill.root.addEventListener("keydown", function (evt) {
                                    ...
                                    var _quill$scroll$line = _this2.quill.scroll.line(
                                        range.index
                                    );

                                    var _quill$scroll$line2 = _slicedToArray(
                                        _quill$scroll$line,
                                        2
                                    );
                                    ...
                                    var _quill$scroll$leaf = _this2.quill.scroll.leaf(
                                        range.index
                                    );

                                    var _quill$scroll$leaf2 = _slicedToArray(
                                        _quill$scroll$leaf,
                                        2
                                    );
                                    ...
                                    var _ref =
                                        range.length === 0
                                            ...
                                            : _this2.quill.scroll.leaf(range.index + range.length);
                ...
                function makeCodeBlockHandler(indent) {
                    return {
                        ...
                        handler: function handler(range) {
                            ...
                            var _quill$scroll$descend2 = _slicedToArray(
            ...
            /***/ function (module, exports, __webpack_require__) {
                ...
                var List = (function (_Container) {
                    ...
                    function List() {
                        ...
                        return _possibleConstructorReturn(
                            this,
                            (List.__proto__ || Object.getPrototypeOf(List)).apply(
                                this,
                                arguments
                            )
                        );
                        ...
                        [
                            ...
                            },
                            {
                                ...
                                value: function sanitize(url) {
                                    return _sanitize(url, ["http", "https", "mailto"])
                                        ? url
                                        : this.SANITIZED_URL;
                                },
                            },
                ...
                var Toolbar = (function (_Module) {
                    ...
                    function Toolbar(quill, options) {
                        ...
                        _this.quill.on(_quill2.default.events.SCROLL_OPTIMIZE, function () {
                            ...
                            var _this$quill$selection2 = _slicedToArray(
                        ...
                        },
                        {
                            ...
                            value: function attach(input) {
                                ...
                                input.addEventListener(eventName, function (e) {
                                    ...
                                    var _quill$selection$getR2 = _slicedToArray(
                    ...
                    function Tooltip(quill, boundsContainer) {
                        ...
                        this.quill.root.addEventListener("scroll", function () {
                            _this.root.style.marginTop =
                                -1 * _this.quill.root.scrollTop + offset + "px";
                            _this.checkBounds();
                        });
                        this.hide();
                    }
                        ...
                        _this2.quill.on(
                            ...
                            function (type, range) {
                                ...
                                if (range != null && range.length > 0) {
                                    ...
                                    var lines = _this2.quill.scroll.lines(
                                        range.index,
                                        range.length
                                    );
                                    if (lines.length === 1) {
                    ...
                    _createClass(BaseTheme, [
                        ...
                        },
                        {
                            ...
                            value: function buildPickers(selects) {
                                ...
                                this.quill
                                    .on(_emitter2.default.events.SELECTION_CHANGE, update)
                                    .on(_emitter2.default.events.SCROLL_OPTIMIZE, update);
                            },
                        },
                    ]);
