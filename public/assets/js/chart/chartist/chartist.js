     ...
     */
        ...
        (function (window, document, Chartist) {
            ...
            Chartist.normalizePadding = function (padding, fallback) {
                ...
                return typeof padding === "number"
                    ...
                    : {
                        ...
                        right:
                            typeof padding.right === "number" ? padding.right : fallback,
                        bottom:
            ...
            Chartist.createChartRect = function (svg, options, fallbackPadding) {
                ...
                var height =
                    svg.height() || Chartist.quantity(options.height).value || 0;
        ...
        (function (window, document, Chartist) {
            ...
            function createChart(options) {
                ...
                radius -=
                    options.donut && !options.donutSolid ? donutWidth.value / 2 : 0;
                ...
                data.raw.series.forEach(
                    function (series, index) {
                        ...
                        if (
                            data.normalized.series[index] === 0 &&
