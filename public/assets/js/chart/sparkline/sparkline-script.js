(function ($) {
    ...
    setTimeout(function () {
        $("#line-chart-sparkline").sparkline(
            [5, 10, 20, 14, 17, 21, 20, 10, 4, 13, 0, 10, 30, 40, 10, 15, 20],
            {
                ...
                lineColor: ZonoAdminConfig.primary,
                fillColor: "rgba(43, 94, 94, 0.40)",
                highlightLineColor: ZonoAdminConfig.primary,
                highlightSpotColor: ZonoAdminConfig.primary,
                targetColor: ZonoAdminConfig.primary,
                performanceColor: ZonoAdminConfig.primary,
                boxFillColor: ZonoAdminConfig.primary,
                medianColor: ZonoAdminConfig.primary,
                minSpotColor: ZonoAdminConfig.primary,
            }
        );
    });
    ...
    $("#custom-line-chart").sparkline([5, 30, 27, 35, 30, 50, 70], {
        ...
        tooltipClassname: "chart-sparkline",
        chartRangeMax: "50",
        lineColor: ZonoAdminConfig.secondary,
        fillColor: "rgba(2204, 200, 153, 0.30)",
        highlightLineColor: "rgba(2204, 200, 153, 0.30)",
        highlightSpotColor: "rgba(2204, 200, 153, 0.8)",
    });
    $("#custom-line-chart").sparkline([0, 5, 10, 7, 25, 20, 30], {
        ...
        lineColor: ZonoAdminConfig.primary,
        fillColor: "rgba(43, 94, 94, 0.40)",
        highlightLineColor: "rgba(43, 94, 94, 0.40)",
        highlightSpotColor: "rgba(43, 94, 94, 0.8)",
    });
        ...
        init: function () {
            setTimeout(function () {
                ...
                $("#bar-chart-sparkline").sparkline([5, 2, 2, 4, 9, 5, 7, 5, 2, 2, 6], {
                    ...
                    height: "100%",
                    tooltipClassname: "chart-sparkline",
                    barColor: ZonoAdminConfig.primary,
                }),
