    ...
    var morris_chart = {
        init: function () {
            Morris.Area({
                ...
                ykeys: ["y", "z"],
                labels: ["Y", "Z"],
                lineColors: [ZonoAdminConfig.secondary, ZonoAdminConfig.primary],
            }),
                Morris.Line({
                    ...
                    xkey: "y",
                    ykeys: ["a", "b"],
                    lineColors: [ZonoAdminConfig.primary, ZonoAdminConfig.secondary],
                ...
                Morris.Bar({
                    ...
                    ykeys: ["y"],
                    labels: ["Y"],
                    barColors: [ZonoAdminConfig.primary],
                }),
                $(function () {
                    var b = [
                        {
                    ...
                    Morris.Bar({
                        ...
                        data: b,
                        barColors: [ZonoAdminConfig.primary, ZonoAdminConfig.secondary],
                        xkey: "period",
                ...
                $(function () {
                    ...
                    window.m = Morris.Line({
                        ...
                        labels: ["sin(x)"],
                        parseTime: !1,
                        lineColors: [ZonoAdminConfig.primary],
