(function ($) {
    ...
    var options = {
        ...
        colors: [ZonoAdminConfig.secondary],
        fill: {
            type: "gradient",
            gradient: {
                shadeIntensity: 1,
        ...
        markers: {
            discrete: [{
                seriesIndex: 0,
                dataPointIndex: 3,
                fillColor: ZonoAdminConfig.secondary,
                strokeColor: "#fff",
                size: 6,
                shape: "circle"
            },
    ...
    var optionscolumnchart = {
        ...
        colors: [ZonoAdminConfig.secondary, "#479447", ZonoAdminConfig.primary],
        fill: {
            type: "gradient",
            gradient: {
                shade: "light",
            ...
            xaxis: [
                {
                    ...
                    strokeDashArray: 0,
                    borderColor: ZonoAdminConfig.primary,
                    label: {
                        borderColor: ZonoAdminConfig.primary,
                        offsetY: 20,
                        style: {
                            color: "#fff",
                            background: ZonoAdminConfig.primary,
                        },
                        text: "Anno Test",
                    },
                },
    ...
    var optionscandlestickchart = {
        ...
        plotOptions: {
            candlestick: {
                colors: {
                    upward: ZonoAdminConfig.primary,
                    downward: ZonoAdminConfig.secondary,
                },
            },
        },
        legend: {
    ...
    var options = {
        ...
        colors: [ '#bebebe' , ZonoAdminConfig.primary],
        dropShadow: {
            enabled: true,
            top: 5,
            left: 6,
    ...
    var options = {
        ...
        colors: [ZonoAdminConfig.primary, '#EAEAEA'],
        fill: {
            ...
            gradient: {
                ...
                type: "vertical",
                shadeIntensity: 1,
                gradientToColors: [ ZonoAdminConfig.primary, '#fff5f7', ZonoAdminConfig.primary ],
                inverseColors: true,
                opacityFrom: 0.4,
                opacityTo: 0,
                stops: [0, 100, 100, 100],
