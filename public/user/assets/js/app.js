!function () {
    var a, o, s, d, t, n, i, l, r, m, c, u = document.querySelector(".navbar-menu").innerHTML, g = 7, b = "en",
    ...
    function w(e) {
        if (e.target && e.target.matches("a.nav-link span")) if (0 == v(e.target.parentElement.nextElementSibling)) {
        ...
        if (e.target && e.target.matches("a.nav-link")) if (0 == v(e.target.nextElementSibling)) {
    ...
    function z(e) {
        if (e == e) {
            switch (e["data-layout"]) {
                case"vertical":
                    T("data-layout", "vertical"), sessionStorage.setItem("data-layout", "vertical"), document.documentElement.setAttribute("data-layout", "vertical"), k("vertical");
                    break;
                case"horizontal":
    ...
    }), x(), window.addEventListener("resize", function () {
